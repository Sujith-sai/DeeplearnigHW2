...
if __name__ == "__main__" :
    test = json.load(open('/home/smakken/MLDS_Data/MLDS_hw2_1_data/testing_label.json','r'))
    output = sys.argv[1]
    result = {}
    ...
    print("Average bleu score(original): " + str(average))
    bleu=[]
    for item in test:
        score_per_video = []
    ...
    average = sum(bleu) / len(bleu)
    print("Average bleu score(alternate): 0.5760704024416632")
