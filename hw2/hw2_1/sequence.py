...
if __name__ == "__main__":
    ...
    vid_id = [filename[:-4] for filename in feat_filenames]
    ...
    print("ID of 5th video:", vid_id[4])
    print("Shape of features of 5th video:", ID_caption[4][0].shape)
    print("Caption forf 5th video:", ID_caption[4][1])
